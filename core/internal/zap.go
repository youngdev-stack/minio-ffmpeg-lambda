...
func (z *_zap) GetEncoderConfig() zapcore.EncoderConfig {
	return zapcore.EncoderConfig{
		...
		EncodeLevel:    global.GlobalConfig.Zap.ZapEncodeLevel(),
...
func (z *_zap) CustomTimeEncoder(t time.Time, encoder zapcore.PrimitiveArrayEncoder) {
	encoder.AppendString(global.GlobalConfig.Zap.Prefix + t.Format("2006/01/02 - 15:04:05.000"))
}
...
func (z *_zap) GetZapCores() []zapcore.Core {
	...
	for level := global.GlobalConfig.Zap.TransportLevel(); level <= zapcore.FatalLevel; level++ {
